...
<button onclick={addServer} class="relative cursor-pointer w-8 h-8 rounded-xl hover:rounded-lg bg-[#2c2c2c] transition-all flex justify-center items-center group hover:bg-(--accent-color)">
	<Plus color="white" />
